...
$sandbox = (variable_get('uc_commission_sales_paypal_server', 'sandbox') == 'sandbox');
$domain = $sandbox ? 'http://sandbox.audioseeds.com/' : 'http://www.audioseeds.com/';
 ...
 */
$api_username = variable_get('uc_commission_sales_paypal_api_username', '');
$api_password = variable_get('uc_commission_sales_paypal_api_password', '');
$api_signature = variable_get('uc_commission_sales_paypal_api_signature', '');
